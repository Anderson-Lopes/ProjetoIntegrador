        ...
        <div className='container'>
          <CardColumns className='col, row'>
            <Row xs='5'>
              ...
              <CardBody>
                <CardTitle tag="h6">Anfíbios</CardTitle>
              </CardBody>
              </Card>
              <Card className='d-flex flex-column align-items-center '>
              ...
              <CardBody>
                <CardTitle tag="h6">Artrópodes</CardTitle>
              </CardBody>
              </Card>
              <Card className='d-flex flex-column align-items-center '>
              ...
              <CardBody>
                <CardTitle tag="h6">Aves</CardTitle>
              </CardBody>
              </Card>        
              <Card className='d-flex flex-column align-items-center '>
              ...
              <CardBody>
                <CardTitle tag="h6">Cachorros</CardTitle>
              </CardBody>
              </Card>
              <Card className='d-flex flex-column align-items-center '>
              ...
              <CardBody>
                <CardTitle tag="h6">Gatos</CardTitle>
              </CardBody>
              </Card>
              <Card className='d-flex flex-column align-items-center '>
              ...
              <CardBody>
                <CardTitle tag="h6">Iguanas</CardTitle>
              </CardBody>
              </Card>
              <Card className='d-flex flex-column align-items-center '>
              ...
              <CardBody>
                <CardTitle tag="h6">Peixes</CardTitle>
              </CardBody>
              </Card>
              <Card className='d-flex flex-column align-items-center '>
              ...
              <CardBody>
                <CardTitle tag="h6">Répteis</CardTitle>
              </CardBody>
              </Card>
              <Card className='d-flex flex-column align-items-center '>
              ...
              <CardBody>
                <CardTitle tag="h6">Outros</CardTitle>
              </CardBody>
              </Card>
            </Row>
          </CardColumns>
