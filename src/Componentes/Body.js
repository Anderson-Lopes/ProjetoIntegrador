...
import {
  ...
  const Body = (props) => {
    return (
      <div>
        <Container className='infoDog'>
          <Card className='d-flex flex-column align-items-center flex-md-column flex-lg-row'>
        ...
        <br></br>
        <Container>        
        <Row className='pets' sd='2' md='4' xs='4'>
              <Card className='d-flex align-items-center'><br></br>
